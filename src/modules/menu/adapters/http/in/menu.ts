...
export const createMenuHandler = (useCase: CreateMenuUseCase) =>
...
export const deleteMenuHandler = (useCase: DeleteMenuUseCase) =>
...
export const fetchMenuHandler = (query: FetchMenuQuery) =>
